		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Control Hes",
									"targetURL": "#pluspez9451controlhes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pluspez9451controlhes-display": {
								"semanticObject": "pluspez9451controlhes",
								"action": "display",
								"description": "Control Hes",
								"title": "Control Hes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pluspe.z9451controlhes",
									"url": sap.ui.require.toUrl("pluspe/z9451controlhes")
								}
							}
						}
					}
